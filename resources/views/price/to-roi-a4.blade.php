<div class="modal fade price-8" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="price-title">Tờ rơi A4</h5>
            ...
            <div class="modal-body">
                ...
                <div class="d-flex tt_3 line">
                    <div class="line-item">
                        ...
                        <input id="paper-in" type="number" value="26"/>
                    </div>
                    <div class="line-item">
                        <label for="paper-in-2">TT Giấy**</label>
                        <input id="paper-in-2" type="number" value="150"/>
                    </div>
                </div>
                <div class="d-flex tt_3 line">
                    <div class="line-item">
...
{{--                    <div class="line-item">--}}
{{--                        <label for="b-wave-star">Sóng B*</label>--}}
{{--                        <input id="b-wave-star" pattern="[0-9]*" type="number" value="6500"/>--}}
{{--                    </div>--}}
{{--                    <div class="line-item">--}}
{{--                        <label for="b-wave">Sóng B</label>--}}
...
{{--                    </div>--}}
                ...
                <div class="d-flex zn line">
                    ...
                    <div class="line-item">
                        ...
                        <input id="print_tt" pattern="[0-9]*" type="number" value="20"/>
                    </div>
                    <div class="line-item">
                ...
                <div class="d-flex tt_3 line">
                    <div class="line-item">
                        ...
                        <input id="laminate_total" type="number"/>
                    </div>
                    <div class="line-item">
                        <label for="tt_paste">TT Bế, dán</label>
                        <input id="tt_paste" type="number"/>
                    </div>
                </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('.line input').on('input', function () {
            ...
            let paperIn2 = parseFloat($('#paper-in-2').val()) || 0;
            ...
            let laminateTotal = parseFloat($('#laminate_total').val()) || 0;
            let ttPaste = parseFloat($('#tt_paste').val()) || 0;

            // Tính toán
            let square = squareVal;
            let paperTotal = square * paperIn2 * paperQuantity * paperIn;
            ...
            let ttTotal = paperTotal + printTotal + ttMoney;
