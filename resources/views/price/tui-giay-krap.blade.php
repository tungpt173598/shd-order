<div class="modal fade price-11" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="price-title">TÚI GIẤY KRAP</h5>
            ...
            <div class="modal-body">
                ...
                <div class="d-flex zn line">
                    ...
                    <div class="line-item">
                        ...
                        <input id="print_tt" pattern="[0-9]*" type="number" value="25"/>
                    </div>
                    <div class="line-item">
