<div class="modal fade price-5" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="price-title">KẸP FILE A4 IN 2 CÁN 2</h5>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('.line input').on('input', function () {
            ...
            let laminateTotal =  ttCan1 * ttCan2 * ttCan3 * paper_quantity * 2;
