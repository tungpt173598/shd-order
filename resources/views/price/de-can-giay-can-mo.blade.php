<div class="modal fade price-7" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="price-title">TEM DE CAN GIẤY CÁN MỜ</h5>
...
{{--                    </div>--}}
                    ...
                    <div class="line-item">
                        ...
                        <input id="paper-in" type="number" value="19000"/>
                    </div>
                ...
                <div class="d-flex laminate line">
                    <div class="line-item">
                        ...
                        <input id="tt_can_1" value="0.26"/>
                    </div>
                    <div class="line-item">
                        <label for="tt_can_2">TT Cán**</label>
                        <input id="tt_can_2" pattern="[0-9]*" type="number" value="10000"/>
                    </div>
                    <div class="line-item">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('.line input').on('input', function () {
            ...
            let paperTotal = square * paperQuantity * paperIn;
