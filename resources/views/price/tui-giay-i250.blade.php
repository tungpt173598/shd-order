<div class="modal fade price-10" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="price-title">TÚI GIẤY I250</h5>
            ...
            <div class="modal-body">
                ...
                <div class="d-flex tt_3 line">
                    <div class="line-item">
                        ...
                        <input id="paper-in" type="number" value="22"/>
                    </div>
