<div class="modal fade price-12" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="price-title">CATALOG 20 x 20 bìa c250 r c 150</h5>
            ...
            <div class="modal-body">
                ...
                <div class="d-flex paper line">
                    <div class="line-item">
                        ...
                        <input id="length" pattern="[0-9]*" type="number" value="0.62"/>
                    </div>
                ...
                <div class="d-flex zn line">
                    <div class="line-item">
                        ...
                        <input id="tt_giay_bia_1" pattern="[0-9]*" type="number" value="300"/>
                    </div>
                    <div class="line-item">
                        <label for="tt_giay_bia_2">T Giấy bìa**</label>
                        <input id="tt_giay_bia_2" pattern="[0-9]*" type="number" value="21"/>
                    </div>
                    <div class="line-item">
                ...
                <div class="d-flex laminate line">
                    ...
                    <div class="line-item">
                        ...
                        <input id="tt_print_1" pattern="[0-9]*" type="number" value="30"/>
                    </div>
                    <div class="line-item">
                ...
                <div class="d-flex other line">
                    ...
                    <div class="line-item">
                        ...
                        <input id="tay_quantity_1" type="number" value="12"/>
                    </div>
                    <div class="line-item">
                ...
                <div class="d-flex other line">
                    ...
                    <div class="line-item">
                        ...
                        <input id="r_paper_2" type="number" value="21"/>
                    </div>
                    <div class="line-item">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('.line input').on('input', function () {
            ...
            // Tính toán
            let sl_giay_bia = quantity / 3 + quantity_plus
