    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="price-title">PHONG BÌ A 6 OFF 120</h5>
            ...
            <div class="modal-body">
                ...
                <div class="d-flex zn line">
                    <div class="line-item">
                        ...
                        <input id="tt_giay_1" pattern="[0-9]*" type="number" value="120"/>
                    </div>
                    <div class="line-item">
                ...
                <div class="d-flex tt_3 line">
                    <div class="line-item">
                        ...
                        <input id="tt_paste_1" type="number" pattern="[0-9]*" value="120"/>
                    </div>
                    <div class="line-item">
