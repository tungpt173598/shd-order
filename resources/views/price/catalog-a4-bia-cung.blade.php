<div class="modal fade price-14" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="price-title">CATALOG A4, Bìa cứng</h5>
            ...
            <div class="modal-body">
                ...
                <div class="d-flex zn line">
                    ...
                    <div class="line-item">
                        ...
                        <input id="tt_giay_bia_2" pattern="[0-9]*" type="number" value="22.5"/>
                    </div>
                    <div class="line-item">
                ...
                <div class="d-flex other line">
                    <div class="line-item">
                        ...
                        <input id="r_paper_1" type="number" pattern="[0-9]*" value="80"/>
                    </div>
                    <div class="line-item">
                        <label for="r_paper_2">Tiền Giấy R**</label>
                        <input id="r_paper_2" type="number" value="26.5"/>
                    </div>
                    <div class="line-item">
