<div class="modal fade price-13" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="price-title">CATALOG A4, B C250 M 1</h5>
            ...
            <div class="modal-body">
                ...
                <div class="d-flex other line">
                    ...
                    <div class="line-item">
                        ...
                        <input id="tay_quantity_1" type="number" value="8"/>
                    </div>
                    <div class="line-item">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('.line input').on('input', function () {
            ...
            // Tính toán
            let sl_giay_bia = quantity / 2 + quantity_plus
