<div class="modal fade price-1" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="price-title">Hộp sóng B</h5>
            ...
            <div class="modal-body">
                ...
                <div class="d-flex paper line">
                    ...
                    <div class="line-item">
                        ...
                        <input id="paper-in" type="number" value="16.5"/>
                    </div>
                ...
                <div class="d-flex tt_3 line">
                    <div class="line-item">
                        ...
                        <input id="tt_paste_1" type="number" pattern="[0-9]*" value="600"/>
                    </div>
                    <div class="line-item">
