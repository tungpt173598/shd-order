<div class="modal fade price-15" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="price-title">CATALOG A5 Bìa C250 ruột C 150</h5>
            ...
            <div class="modal-body">
                <div class="d-flex paper line">
                    ...
                    <div class="line-item">
                        ...
                        <input id="sl_giay_bia_1" type="number" value="100"/>
                    </div>
                ...
                <div class="d-flex paper line">
                    <div class="line-item">
                        ...
                        <input id="length" pattern="[0-9]*" type="number" value="0.65"/>
                    </div>

                    <div class="line-item">
                        <label for="width">Rộng</label>
                        <input id="width" pattern="[0-9]*" type="number" value="0.43"/>
                    </div>
                </div>
                <div class="d-flex zn line">
                    <div class="line-item">
                        <label for="tt_giay_bia_1">T Giấy bìa*</label>
                        <input id="tt_giay_bia_1" pattern="[0-9]*" type="number" value="250"/>
                    </div>
                    <div class="line-item">
                ...
                <div class="d-flex laminate line">
                    ...
                    <div class="line-item">
                        ...
                        <input id="tt_print_1" pattern="[0-9]*" type="number" value="25"/>
                    </div>
                    <div class="line-item">
                ...
                <div class="d-flex other line">
                    ...
                    <div class="line-item">
                        ...
                        <input id="tt_can_bia_2" type="number" value="62"/>
                    </div>
                    <div class="line-item">
                        <label for="tt_can_bia_3">TT Cán bìa**</label>
                        <input id="tt_can_bia_3" type="number" value="0.26"/>
                    </div>
                </div>
                ...
                <div class="d-flex tt_3 line">
                    <div class="line-item">
                        ...
                        <input id="length_r" pattern="[0-9]*" type="number" value="0.65"/>
                    </div>
                ...
                <div class="d-flex other line">
                    <div class="line-item">
                        ...
                        <input id="r_paper_1" type="number" pattern="[0-9]*" value="120"/>
                    </div>
                    <div class="line-item">
                ...
                <div class="d-flex laminate line">
                    ...
                    <div class="line-item">
                        ...
                        <input id="tt_print_1_in" pattern="[0-9]*" type="number" value="25"/>
                    </div>
                    <div class="line-item">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('.line input').on('input', function () {
            ...
            // Tính toán
            let sl_giay_bia = quantity / 4 + quantity_plus
            ...
            $('#sl_giay_bia').val(Math.round(sl_giay_bia));
