<div class="modal fade price-9" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="price-title">TÚI GIẤY -C 300 cán mờ</h5>
            ...
            <div class="modal-body">
                ...
                <div class="d-flex tt_3 line">
                    <div class="line-item">
                        ...
                        <input id="paper-in" type="number" value="22.5"/>
                    </div>
                ...
                <div class="d-flex tt_3 line">
                    <div class="line-item">
                        ...
                        <input id="tt_paste_1" type="number" pattern="[0-9]*" value="1700"/>
                    </div>
                    <div class="line-item">
