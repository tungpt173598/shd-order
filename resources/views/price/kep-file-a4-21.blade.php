<div class="modal fade price-6" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="price-title">KẸP FILE A4 IN 2 CÁN 1</h5>
            ...
            <div class="modal-body">
                ...
                <div class="d-flex tt_3 line">
                    <div class="line-item">
                        ...
                        <input id="length" pattern="[0-9]*" value="0.46"/>
                    </div>
                ...
                <div class="d-flex zn line">
                    ...
                    <div class="line-item">
                        ...
                        <input id="tt_paper_2" pattern="[0-9]*" type="number" value="28"/>
                    </div>
                    <div class="line-item">
