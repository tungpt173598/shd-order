<div class="modal fade price-3" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="price-title">HỘP GIẤY I 350 CÁN MỜ</h5>
            ...
            <div class="modal-body">
                ...
                <div class="d-flex tt_3 line">
                    ...
                    <div class="line-item">
                        ...
                        <input id="paper-in" type="number" value="25.5"/>
                    </div>
