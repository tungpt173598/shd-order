<div class="modal fade price-18" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="price-title">PHONG BÌ A 5 OFF 120</h5>
            ...
            <div class="modal-body">
                ...
                <div class="d-flex zn line">
                    <div class="line-item">
                        ...
                        <input id="tt_giay_1" pattern="[0-9]*" type="number" value="200"/>
                    </div>
                    <div class="line-item">
                ...
                <div class="d-flex tt_3 line">
                    <div class="line-item">
                        ...
                        <input id="tt_paste_1" type="number" pattern="[0-9]*" value="130"/>
                    </div>
                    <div class="line-item">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('.line input').on('input', function () {
            ...
            // Tính toán
            let paper_total = quantity / 2 + paper_plus;
